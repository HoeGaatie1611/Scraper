...
const url = "https://slotcatalog.com/en/slots/Starburst";
...
request(url, function(err, response, html) {
    if(!err) {
        ...
        if(release !== "") {
            table.push([provider, name, release, variance, RTP, betways, layout, maxcoins, technology, minbet, maxbet, devices, features, tags]);
        }
